...
{
    class SkyboxPass final : public RHI::FrameGraphPass
    {
    public:
        SkyboxPass(std::string a_name,
            ...
            const RHI::ViewHandle& a_textureSrvHandle) noexcept
            ...
            , m_textureSrvHandle(a_textureSrvHandle)
        {}
        ...
        Result setup(RHI::FrameGraphBuilder& builder) override
        {
            ...
            vertexShaderDesc.filePath = "Shaders/D3D12/Skybox.hlsl";
            ...
            pixelShaderDesc.filePath = "Shaders/D3D12/Skybox.hlsl";
        ...
        void execute(RHI::FrameGraphContext& context) override
        {
            ...
            commandContext->set_graphics_descriptor_table(1, m_textureSrvHandle);
            commandContext->draw_instanced(k_vertexCount, 1, 0, 0);
        }

    private:
        static constexpr uint32_t k_vertexCount = 36;
        ...
        const RHI::ViewHandle& m_textureSrvHandle;
    };
} // namespace Cue::DrawSystem
