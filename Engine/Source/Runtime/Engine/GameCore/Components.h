...
namespace Cue::ECS {
enum class AudioEncoding : uint8_t { Pcm, Adpcm };
...
struct RenderableInfoComponent : public IComponentTag {
  ...
  RenderableInfoComponent &operator=(const RenderableInfoComponent &) = default;
...
struct UiRectTransformComponent : public IComponentTag {
  ...
  operator=(const UiRectTransformComponent &) = default;
  UiRectTransformComponent(UiRectTransformComponent &&) = default;
  UiRectTransformComponent &operator=(UiRectTransformComponent &&) = default;
...
struct UiLayoutGroupComponent : public IComponentTag {
  ...
  UiLayoutGroupComponent &operator=(const UiLayoutGroupComponent &) = default;
...
struct DirectionalLightComponent : public IComponentTag {
  ...
  operator=(const DirectionalLightComponent &) = default;
...
struct StaticMeshRendererComponent : public IComponentTag {
  ...
  operator=(const StaticMeshRendererComponent &) = default;
  StaticMeshRendererComponent(StaticMeshRendererComponent &&) = default;
  StaticMeshRendererComponent &
  operator=(StaticMeshRendererComponent &&) = default;
...
struct SkinnedMeshRendererComponent : public IComponentTag {
  ...
  operator=(const SkinnedMeshRendererComponent &) = default;
  SkinnedMeshRendererComponent(SkinnedMeshRendererComponent &&) = default;
  SkinnedMeshRendererComponent &
  operator=(SkinnedMeshRendererComponent &&) = default;
  MaterialHandle materialHandle{};
  MaterialPropertyBlock propertyBlock{};
  RenderQueue renderQueue = RenderQueue::Auto;
  ShadowCasterMode shadowCasterMode = ShadowCasterMode::Solid;
...
enum class ParticleBillboardMode : uint32_t { View = 0 };

struct ParticleEmitterComponent : public IComponentTag {
  ParticleEmitterComponent() = default;
  ParticleEmitterComponent(const ParticleEmitterComponent &) = default;
  ParticleEmitterComponent &
  operator=(const ParticleEmitterComponent &) = default;
...
struct EffectEmitterComponent : public IComponentTag {
  ...
  EffectEmitterComponent &operator=(const EffectEmitterComponent &) = default;
  ...
  float primitiveTimeSeconds = 0.0f;
  uint32_t randomSeed = 1;
  bool isPlaying = true;
  bool isVisible = true;
...
struct CharacterControllerComponent : public IComponentTag {
  ...
  operator=(const CharacterControllerComponent &) = default;
  CharacterControllerComponent(CharacterControllerComponent &&) = default;
  CharacterControllerComponent &
  operator=(CharacterControllerComponent &&) = default;
...
[[nodiscard]] inline constexpr ScriptFieldFlags
operator|(ScriptFieldFlags a_left, ScriptFieldFlags a_right) noexcept {
  return static_cast<ScriptFieldFlags>(static_cast<uint32_t>(a_left) |
...
struct ScriptFieldValue final {
  ...
  ScriptFieldReferenceRole referenceRole = ScriptFieldReferenceRole::None;
  ScriptFieldFlags flags =
      ScriptFieldFlags::EditAnywhere | ScriptFieldFlags::Serialize;
};
