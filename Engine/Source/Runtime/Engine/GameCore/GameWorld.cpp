...
namespace Cue::GameCore
{
    ...
    {
        return TransformSystem::set_parent(*this, a_childEntityId, a_parentEntityId, a_keepsWorldTransform);
    }

    Result GameWorld::detach_parent(EntityId a_childEntityId, bool a_keepsWorldTransform) noexcept
    {
        return TransformSystem::detach_parent(*this, a_childEntityId, a_keepsWorldTransform);
    }
