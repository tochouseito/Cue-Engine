...
struct MeshletChunkVisibilityStatsGpu {
  ...
  uint32_t instanceCount = 0;
  uint32_t currentVisibleChunkCount = 0;
  uint32_t previousVisibleChunkCount = 0;
  uint32_t testedObjectChunkCount = 0;
  uint32_t rejectedByPreviousVisibility = 0;
  uint32_t rejectedByFrustum = 0;
  uint32_t commandOverflowCount = 0;
  uint32_t totalObjectCount = 0;
  uint32_t visibleObjectCount = 0;
  uint32_t culledObjectCount = 0;
  uint32_t rejectedByOccluderFilter = 0;
  uint32_t rejectedByObjectFilter = 0;
  uint32_t skippedChunksByObjectFilter = 0;
  uint32_t skippedChunksByMaxChunks = 0;
  uint32_t selectedObjectCount = 0;
  uint32_t maxChunksPerObject = 0;
  uint32_t minObjectScreenRadiusPx = 0;
  uint32_t minChunkScreenRadiusPx = 0;
  uint32_t maxViewDepth = 0;
  uint32_t maxDepthBin = 0;
  uint32_t occlusionEnabled = 0;
  uint32_t occlusionTestedCount = 0;
  uint32_t occlusionRejectedCount = 0;
};

struct MeshletGroupCullStatsGpu {
  uint32_t visibleObjectCount = 0;
  uint32_t candidateObjectCount = 0;
  uint32_t testedGroupCount = 0;
  uint32_t frustumRejectedGroupCount = 0;
  uint32_t coneTestedMeshletCount = 0;
  uint32_t coneRejectedMeshletCount = 0;
  uint32_t visibleGroupCount = 0;
  uint32_t culledObjectCount = 0;
  uint32_t fallbackObjectCount = 0;
  uint32_t rangeObjectCount = 0;
