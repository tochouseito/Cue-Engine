// ParticleSpriteForwardPass の役割と公開要素を定義する
...
{
    class ParticleSpriteForwardPass final : public RHI::FrameGraphPass
    {
    public:
        ParticleSpriteForwardPass(std::string a_name,
        ...
        Result setup(RHI::FrameGraphBuilder& builder) override
        {
            ...
            vertexShaderDesc.filePath = "Shaders/D3D12/ParticleSpriteForward.hlsl";
            ...
            pixelShaderDesc.filePath = "Shaders/D3D12/ParticleSpriteForward.hlsl";
