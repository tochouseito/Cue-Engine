// ParticleTrailForwardPass の役割と公開要素を定義する
...
{
    class ParticleTrailForwardPass final : public RHI::FrameGraphPass
    {
    public:
        ParticleTrailForwardPass(std::string a_name,
        ...
        Result setup(RHI::FrameGraphBuilder& builder) override
        {
            ...
            result = builder.read_buffer(m_frameBufferHandle);
            if (!result)
            {
                return result;
            }
            ...
            rootSignatureDesc.parameters.push_back({
                RHI::RootParameterType::CBV, RHI::ShaderVisibility::Vertex, 1 });
            rootSignatureDesc.parameters.push_back({
            ...
            vertexShaderDesc.filePath = "Shaders/D3D12/ParticleTrailForward.hlsl";
            ...
            pixelShaderDesc.filePath = "Shaders/D3D12/ParticleTrailForward.hlsl";
        ...
        void execute(RHI::FrameGraphContext& context) override
        {
            ...
            commandContext->set_cbv(1, m_frameBufferHandle);
            commandContext->set_srv(2, m_particleBufferHandle);
            commandContext->set_srv(3, m_trailBufferHandle);
            commandContext->set_graphics_texture_table(4);
            commandContext->draw_instanced(
                6 * GpuData::k_maxParticleTrailSegmentCount,
