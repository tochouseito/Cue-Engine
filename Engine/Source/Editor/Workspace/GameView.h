...
{
    public:
    explicit GameView(RHI::DX12::D3D12Backend* a_backend) noexcept : m_backend(a_backend)
    {
    }
    ...
    [[nodiscard]] static ImVec2 calculate_fit_size(ImVec2 a_availableRegion, uint32_t a_textureWidth,
