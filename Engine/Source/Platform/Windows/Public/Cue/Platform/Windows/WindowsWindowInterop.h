...
class NativeWindowView final
{
  ...
  private:
    friend Result<NativeWindowView> get_native_window_view(Window &a_window) noexcept;
 ...
 */
[[nodiscard]] Result<NativeWindowView> get_native_window_view(Window &a_window) noexcept;
} // namespace cue
