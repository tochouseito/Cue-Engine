...
execute_process(
    COMMAND "${TEST_EXECUTABLE}" --presentation-smoke "${MODE}" --width 640 --height 360
...
if(NOT testResult EQUAL 0)
    message(
        FATAL_ERROR
        "D3D12 Presentation smoke exited with ${testResult}\n${testOutput}\n${testError}"
    )
endif()
...
foreach(
    ...
    if(messagePosition EQUAL -1)
        message(FATAL_ERROR "D3D12 Presentation smoke output is missing: ${requiredMessage}")
    endif()
endforeach()
...
if(NOT liveObjectErrorPosition EQUAL -1)
    message(FATAL_ERROR "D3D12 Presentation smoke emitted a D3D12 Error\n${combinedOutput}")
endif()

message(STATUS "D3D12 Presentation smoke (${MODE}): passed")
